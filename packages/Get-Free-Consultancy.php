  ...
  <div class="container">
    <div class="row">
      <div class="col-md-push-2 col-md-8 col-xs-12">
        ...
        <form method="POST" action="../includes/contact.php" id="quoteFormBottom" autocomplete="off">
          ...
          <input type="hidden" name="page" value="https://www.designproficient.com/contact" />
        </form>
      </div>
      <!-- end col-md-6 --> 
