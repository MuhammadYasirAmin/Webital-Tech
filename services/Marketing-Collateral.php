...
<title> leading digital marketing company in USA </title> 

<meta name="description" content="using marketing techniques to promote your company and provides useful marketing solutions to boost up your audience." />

<meta name="keyword" content=" digital marketing, marketing collaterals, brand collateral, marketing agency, online advertising, advertisement"/>
    ...
    <div class="tp-banner" >
      <ul>
        ...
        <li data-transition="fade" data-slotamount="0" data-masterspeed="0" > 
          <!-- MAIN IMAGE --> 
          <img src="https://webitaltech.com/img/Marketing-Collateral.png"   alt="slidebg1"  data-bgfit="cover" data-bgposition="top center" data-bgrepeat="no-repeat"> 
          ...
          <div class="tp-caption mediumlarge_light_white_center fade"
            ...
            style="z-index: 6"><h1>Effective Marketing Collateral Design Service for the Perfect Impression</h1></div>
          ...
          <div class="tp-caption medium_light_black fade"
            ...
            data-endeasing="Power1.easeIn"
            data-captionhidden="off"
            style="z-index: 6">With Web Ital Tech marketing collateral, we provide the best design for you and your business and maintain the credibility of your brand name.
...
<section class="section-padding service-detail service-drop-down hideweb">
    ...
    <section class="breakdown">
      <div class="row">
        <div class="col-md-7 col-sm-7 col-lg-7 col-xs-12">
          <h3 class="text-left breakdown-before-left">Well-known Marketing Collateral Design Agency in San Francisco. </h3>
                      <p class="text-left">Web Ital Tech is a well-known marketing collateral design company in San Francisco that provides creative and ground-breaking marketing collateral design solutions to users around the world. Our design of marketing collateral helps the company to create sophisticated and award-winning marketing collateral designed to make brand advertising more manageable and more effective. Our professional designer of marketing collateral can ensure that you invest strategically in creating your brand image.</p>
                    <ul>
                                                <li><i class="fa fa-check-circle-o" aria-hidden="true"></i> Brochure Design</li>
                                    <li><i class="fa fa-check-circle-o" aria-hidden="true"></i> Infographic Design</li>
                                    <li><i class="fa fa-check-circle-o" aria-hidden="true"></i> Sales Presentation Design</li>
                                    <li><i class="fa fa-check-circle-o" aria-hidden="true"></i> Company Profile Design</li>
                                    <li><i class="fa fa-check-circle-o" aria-hidden="true"></i> Newsletter Design</li>
                      </ul>
        </div>
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 margin-bottom-10">
      <input type="text" autocomplete="off" class="form-control" placeholder="Country" name="country" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Country'"   required="required"/>
                      ...
                      <input type="hidden" name="interest" value=" Well-known Marketing Collateral Design Agency in San Francisco.  ">
  ...
  <input type="hidden" name="page" value="https://webitaltech.com/services/Marketing-Collateral" />
</form>
 </div>
        </div>
      </div>
...
<section class="section-padding process wow">
	<div class="container">
		<div class="clearfix">
	        ...
	        <div class="process-img services-processes-icons icon-brief-collateral-process" ></div>
		                <h4>Brief</h4>
		                <p>We believe that marketing collateral contains the core of the company; that is why we discuss the project briefly.</p>
	      </div>
	      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center cust-slider">
	        <div class="process-img services-processes-icons icon-concept-collateral-process"></div>
		                <h4>Idea</h4>
		                <p>Design thinking is the most crucial part of the process. The more individual the design, the easier it is to see results in terms of return on investment.</p>
	      </div>
	      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center cust-slider">
	        <div class="process-img services-processes-icons icon-result-collateral-process"></div>
		                <h4>Results</h4>
		                <p>GORGEOUSLY CRAFTED DESIGNS ARE WHAT HELP US STAND APART FROM OUR INDEFINITE COMPETITION. WE BELIEVE IN RESULTS THAT MATTER AND IT HAS ALWAYS BEEN THAT WAY.</p>
	      </div>
          </div>
  ...
  <div data-scrollable="contests">
    <div data-scrollable-inner="" data-size="0">
      <div class="contest-list contest-list--scrollable">
        ...
        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio01" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_05.png"></a>
          </div>
        </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio05" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_06.png"></a>
          </div>
        </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio06" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_08.png"></a>
          </div>
        </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio08" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_09.png"></a>
          </div>
        </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio21" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_10.png"></a>
          </div>
        </div>
  ...
  <div data-scrollable="contests">
    <div data-scrollable-inner="" data-size="1500">
      <div class="contest-list contest-list--scrollable">
        ...
        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio10" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_11.png"></a>
          </div>
        </div>

        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio07" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_12.png"></a>
          </div>
        </div>

        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio13" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_13.png"></a>
          </div>
        </div>

        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio02" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_14.png"></a>
          </div>
        </div>

        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio11" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_15.png"></a>
          </div>
        </div>

        <div class="contest-list__item">
          <div class="contest">
            <a href="#portfolio19" data-toggle="modal" ><img src="https://webitaltech.com/img/portfolio-services/logo/logo_portfolio_16.png"></a>
          </div>
        </div>
