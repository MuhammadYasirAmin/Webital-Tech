...
<title> Digital marketing services| webitaltech </title>

<meta name="description" content="webitaltech provides you with top quality digital marketing solutions that will help in reaching your target audience. Effective digital marketing done by professionals." />

<meta name="keywords" content=" digital marketing, online marketing, internet marketing, online digital marketing in USA and Dubai, online advertising, digital marketing company, marketing agency."/>
    ...
    <div class="tp-banner" >
      <ul>
        ...
        <li data-transition="fade" data-slotamount="0" data-masterspeed="0" > 
          <!-- MAIN IMAGE --> 
          <img src="https://webitaltech.com/img/Digital-Marketing.png"   alt="slidebg1"  data-bgfit="cover" data-bgposition="top center" data-bgrepeat="no-repeat"> 
          ...
          <div class="tp-caption mediumlarge_light_white_center fade"
            ...
            style="z-index: 6"><h1>Grow Your Business With Digital Marketing!</h1></div>
          ...
          <div class="tp-caption medium_light_black fade"
            ...
            data-endeasing="Power1.easeIn"
            data-captionhidden="off"
            style="z-index: 6">Web Ital Tech is one of the leading Digital marketing agency in San Francisco, California, San Diego and other regions of the US. We have highly skilled SEO experts, social media specialists and content writers that give us ultimate capabilities to handle any digital marketing project. 
...
<section class="section-padding service-detail service-drop-down hideweb">
    ...
    <section class="breakdown">
      <div class="row">
        <div class="col-md-7 col-sm-7 col-lg-7 col-xs-12">
          <h3 class="text-left breakdown-before-left">Why Choose Web Ital Tech as Your Digital Marketing Partner</h3>
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-xs-12 margin-bottom-10">
      <input type="text" autocomplete="off" class="form-control" placeholder="Country" name="country" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Country'"   required="required"/>
                      ...
                      <input type="hidden" name="interest" value=" Why Choose Web Ital Tech as Your Digital Marketing Partner ">
  ...
  <input type="hidden" name="page" value="https://webitaltech.com/services/Digital-Marketing" />
</form>
 </div>
        </div>
      </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <div class="single ">
              ...
              <span class="inclusive-black"><a href="https://webitaltech.com/package/Social-StartUp-Package.php">VIEW DETAILS</a> </span>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <div class="single">
              ...
              <span class="inclusive-black"><a href="https://webitaltech.com/package/Social-Classic-Package.php">VIEW DETAILS</a> </span>
              <div class="actions row">
                                <div class="col-md-6 col-xs-6"><a class="action-no gre clearfix"> <span><small>Share your idea?</small>+1-409-916-8842</span></a></div>
                                <div class="col-md-6 col-xs-6"><a onclick="contactpage()" class="action-chat ali clearfix pull-right" tabindex="0"> <span><small>Want to discuss?</small> Live Chat Now</span></a></div>
                            </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <div class="single">
              ...
              <span class="inclusive-black"><a href="https://webitaltech.com/package/Social-Premium-Package.php">VIEW DETAILS</a> </span>
              <div class="actions row">
                                <div class="col-md-6 col-xs-6"><a class="action-no gre clearfix"> <span><small>Share your idea?</small>+1-409-916-8842</span></a></div>
                                <div class="col-md-6 col-xs-6"><a onclick="contactpage()" class="action-chat ali clearfix pull-right" tabindex="0"> <span><small>Want to discuss?</small> Live Chat Now</span></a></div>
                            </div>
        ...
        <div class="contest-list__item">
          <div class="contest">
            <div class="single">
              ...
              <span class="inclusive-black"><a href="https://webitaltech.com/package/Social-Unlimited-Package.php">VIEW DETAILS</a> </span>
...
<section class="section-padding process wow">
	<div class="container">
		<div class="clearfix">
	        ...
	        <div class="process-img services-processes-icons icon-plan-digital-process" ></div>
		                <h4>Social Media Management</h4>
		                <p>Web Ital Tech has a team of expert social marketers that can create, manage, and deliver the best performing social media campaigns for your business globally. We, as a digital marketing agency, would position our clients to become influencers through social media marketing (SMM). All of our campaigns deliver engaging content, increase followers, and increase word of mouth. </p>
	      </div>
	      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center cust-slider">
	        <div class="process-img services-processes-icons icon-measure-digital-process"></div>
		                <h4>PPC Management</h4>
		                <p>People all over the world are searching for your business online right now. They are using a search engine like Google, Bing &amp; Yahoo to find top digital marketing companies that meet their needs. Search engine marketing (PPC) lets you run advertisements on Google. Here at Web Ital Tech, we know how to manage PPC to optimize your website rank on top of the search engine list.</p>
	      </div>
	      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center cust-slider">
	        <div class="process-img services-processes-icons icon-discover-digital-process"></div>
		                <h4>Search Engine Optimization</h4>
		                <p>SEO - Help potential clienteles find you on a search engine such as Google. As a digital marketing agency Web Ital Tech offers search engine optimization services to help your website rank in top SERP pages by using the most important keywords relevant to your services and products.</p>
	      </div>
          </div>
