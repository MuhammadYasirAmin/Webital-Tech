...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (isset($_POST['remember'])) {
            setcookie('webitaltechSiteemailcookie', $email, time() + (10 * 365 * 24 * 60 * 60));
            setcookie('webitaltechSitepasswordcookie', $pass, time() + (10 * 365 * 24 * 60 * 60));
        }
...
<head>
    <title>WEBITAL-TECH - Login</title>
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30" style="transform: scale(0.7); background-color: #FFFFFF; border: 1px solid #DBDBDB;">
                <form class="login100-form validate-form" action="#" method="POST" autocomplete="off">
                    ...
                    <div class="wrap-input100 validate-input m-b-16">
                        <input class="input100 email" type="email" name="email" placeholder="Email" value="<?php if (isset($_COOKIE['webitaltechSiteemailcookie'])) {echo $_COOKIE['webitaltechSiteemailcookie'];} ?>" required>
                    ...
                    <div class="wrap-input100 validate-input m-b-16">
                        <input class="input100 password" type="password" name="password" placeholder="Password" value="<?php if (isset($_COOKIE['webitaltechSitepasswordcookie'])) {echo $_COOKIE['webitaltechSitepasswordcookie'];} ?>" required>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="container-login100-form-btn p-t-25">
                        <button style="background-color: #47A2F2;" class="login100-form-btn" type="submit" name="login">
                            Login
                        </button>
                    </div>
