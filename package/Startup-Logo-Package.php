...
<title>Startup Logo package | Logo design services | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Exceptional Logo Package for Startups and Mid-Sized Businesses</h3>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="clearfix">
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$168.00 <i class="cut"></i></span> <span class="price">$84.00 </span>             <ul class="no-scroll">
