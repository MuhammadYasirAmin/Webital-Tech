...
<title>Startup Web Package | Web development packages | Web Ital Tech</title>


<meta name="description" content="This package is suitable for small companies and seed sized startups aiming for web based success." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">The Perfect Boost For Your Startup Over The World Wide Web</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Startup Web Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Building a startup is perhaps the hardest yet innovative thing that you can do. The startup web package is the perfect and perhaps the most budget friendly package that you could possibly find in the industry. The package includes a staggering 5-page website together with an SEO friendly Google Sitemap. With a money back guarantee together with an amazing customer satisfaction rate, this deal is easily the best to take.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for small companies and seed sized startups aiming for web based success.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$788.00 <i class="cut"></i></span> <span class="price">$394.00 </span>             <ul class="no-scroll">
