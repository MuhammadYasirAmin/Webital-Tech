...
<title>Elite Combo Package | Brand development Services</title>


<meta name="description" content="This package is suitable for world class brands looking for an all in one brand package." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Best In Class Brand Development Solutions For Elite Businesses</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Elite Combo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">The best in class always prefer the best in branding. The Elite Combo package is just what you need to remain the best in class for your branding solutions. From logo design to icon design, we’re here to change the way you look in a professional manner. Get yourself the elite combo package today.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for world class brands looking for an all in one brand package. </p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$7,998.00 <i class="cut"></i></span> <span class="price">$3,994.00 </span>             <ul class="no-scroll">
