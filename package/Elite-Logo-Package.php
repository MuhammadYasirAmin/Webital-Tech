...
<title>Elite Logo package | Logo design agency | Web Ital Tech</title>


<meta name="description" content="This package is suitable for mega brand and huge-sized corporations looking for suitable creative brand identity solutions." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Top Notch Logo Design Solutions For Monster-Sized Corporations</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Elite Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For corporations succeeding at a supersized scale, top quality brand development solutions are a must. With the Elite Logo Package, you can get nothing but the best logo solutions that we have and that too on the best price. Unlimited designs, Unlimited Revisions, Free Stationary Design and much more.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for mega brand and huge-sized corporations looking for suitable creative brand identity solutions.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$348.00 <i class="cut"></i></span> <span class="price">$174.00 </span>             <ul class="no-scroll">
