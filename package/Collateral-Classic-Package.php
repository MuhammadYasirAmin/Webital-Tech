...
<title>Classic Collateral Package | Digital Marketing | Web Ital Tech</title>


<meta name="description" content="This package is suitable for mid-sized corporations looking for a budget friendly collateral design and development package." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Redefining Class With Excellently Designed Marketing Collateral</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Classic Collateral Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">A classy corporate business owner will always look for a classy corporate solution to things and the Classic Collateral package is just that. The classic collateral package was made by the best business and design analysts in the business for corporations who are eager to make a mark on the industry.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for mid-sized corporations looking for a budget friendly collateral design and development package.</p>
