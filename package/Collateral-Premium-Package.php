...
<title>Premium Collateral Package | Digital Marketing | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Exceptional Collateral Design Solutions For Supreme Corporations</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Premium Collateral Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">A good businessman would look for a good collateral design package, but a great business owner will always look for the best design package at the right price. Our Premium Collateral Package features just that and that too with exceptional concepts that leave the viewer craving for more.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$798.00 <i class="cut"></i></span> <span class="price">$399.00 </span>             <ul class="no-scroll">
