...
<title>Basic Logo package | Logo design packages | Web Ital Tech</title>


<meta name="description" content="Are you a startup company and looking for brand identity solutions for your business then basic logo package suits the best for your business today." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">The Perfect Logo Package for Small Sized Corporate or Personal Packages</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Basic Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Good things come in small packages and so does our logo package. Our basic logo package is currently one of our bestselling packages providing our customers with 2 custom logo design concepts from 1 dedicated designer. Don’t like it? Change it! You can revise your concepts a not once, not twice but four times. With 100% satisfaction rate, we’re the best pick that you can get at a budget!</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This project is suitable for small corporate projects and small personal projects on a budget with a quick turnaround time.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$88.00 <i class="cut"></i></span> <span class="price">$44.00 </span>             <ul class="no-scroll">
