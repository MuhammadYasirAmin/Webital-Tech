...
<title>3D Logo Package | Logo Design Services | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Three-Dimensional Logo Concepts For Emerging Creative Companies </h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>3D Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">One of our bestsellers is the 3D logo package, a personal favorite for many of our clients. The 3D logo package is fit for companies that are creative and like to take things to the next level. The package provides 4 3D logo concepts by some of our creative workers and designers.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,088.00 <i class="cut"></i></span> <span class="price">$544.00 </span>             <ul class="no-scroll">
