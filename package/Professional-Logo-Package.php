...
<title>Professional Logo package | Logo design company | Web Ital Tech</title>


<meta name="description" content="This package is suitable for mega startups and mid-sized corporations looking for suitable creative Logo Design Solutions." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Brand Identity Solutions For Future Corporate Giants To Set Them A Class Apart</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Professional Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For huge organizations and institutions that aim to create a change in the market, this is just the package. The professional logo package features unlimited concepts by three of the best creative thinkers that we have. With a professional stationary design set and MS Word letterhead that comes in complimentary with the package, this is just what you need to make your business a success.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for mega startups and mid-sized corporations looking for suitable creative brand identity solutions.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$248.00 <i class="cut"></i></span> <span class="price">$124.00 </span>             <ul class="no-scroll">
