...
<title>Premium Video Package | Video production company | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Video Premium Production Services For Creative Advertising Solutions</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Premium Video Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Our team of video animators created the video premium package for brands that depend of excessive use of video and need solutions on a budget. Get videos produced near perfection with the video premium package. Get yourself the video premium package today.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$2,998.00 <i class="cut"></i></span> <span class="price">$1499.00 </span>             <ul class="no-scroll">
                            ...
                            <li>No Refund After Script Approval</li>
                          </ul>
