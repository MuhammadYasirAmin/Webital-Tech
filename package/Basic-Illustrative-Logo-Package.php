...
<title>Basic Illustrative Logo Package | Logo Design agency | Web Ital Tech</title>


<meta name="description" content="This project is suitable for small corporate projects and small personal projects on a budget with a quick turnaround time." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Out Of The Box Illustrative Logos For Seed Sized Startups</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Basic Illustrative Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">The Basic Illustrative Logo Package is currently the best illustrative logo package for small personal and corporate projects. The package comes with 3 beautiful illustrative concepts by 2 of the best designers we have. Don’t like it? Revise it! Our basic illustrative package is perhaps one of the best packages that you could find.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$588.00 <i class="cut"></i></span> <span class="price">$284.00 </span>             <ul class="no-scroll">
