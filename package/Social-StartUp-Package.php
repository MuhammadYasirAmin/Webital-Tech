...
<title>Startup Social Package | Digital Marketing agency | Web Ital Tech</title>


<meta name="description" content="This package is suitable for seed-sized brands and startups seeking social media marketing services for personal or professional projects." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Assisting Seed Sized Brands With Social Media Marketing Solutions</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Startup Social Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For a small emerging brands and startups, existence on social media is very important. Our digital marketing experts teamed up with our brand analysts to create a package made solely for seed sized companies and startups called the social startup package. For a startup, this is the best package that you can possibly get.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for seed-sized brands and startups seeking social media marketing services for personal or professional projects.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$198.00 <i class="cut"></i></span> <span class="price">$99.00 </span>             <ul class="no-scroll">
