...
<title>Professional Website Package | Web design agency | Web Ital Tech</title>


<meta name="description" content="This package is suitable for Mid-Sized and Mega Sized corporations aiming for web based success." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Top Class Web Solutions For Mega Corporations Globally</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Professional Web Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">The world wide web is currently the hub to some of the best businesses in the world. With the competition this tough, even the best businesses around the world pull on their battle armors. Are you looking for exceptional web solutions? The professional web package is just what you need.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for Mid-Sized and Mega Sized corporations aiming for web based success.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,688.00 <i class="cut"></i></span> <span class="price">$844.00 </span>             <ul class="no-scroll">
