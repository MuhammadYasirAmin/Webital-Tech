...
<title>E-Commerce Elite Package | Web Solutions | Web Ital Tech</title>


<meta name="description" content="This package is suitable for monster sized e-stores looking for exceptional e-commerce solutions." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">World Class E-Commerce Solutions For World Class E-Stores.</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>E-Commerce Elite Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For stores that are looking for world class e-commerce development solutions, this is just the package! The Ecommerce elite package is currently the best package in terms of ecommerce design and development that we have. The package includes the best features for your ecommerce store and that too complete to the very core.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for monster sized e-stores looking for exceptional e-commerce solutions.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$7,388.00 <i class="cut"></i></span> <span class="price">$3,694.00 </span>             <ul class="no-scroll">
