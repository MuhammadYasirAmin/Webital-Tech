...
<title>Elite Website Package | Web development company | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Superb Web Solutions for Super-Sized Companies Worldwide.</h3>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="clearfix">
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$2,988.00 <i class="cut"></i></span> <span class="price">$1,494.00 </span>             <ul class="no-scroll">
