...
<title>Premium Social Package | Social media marketing | Web Ital Tech</title>


<meta name="description" content="This package is suitable for well-established seeking social media marketing services for personal or professional projects." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Premium Social Media Marketing Solutions For Well-Established Brands</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Premium Social Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Our team of social and digital marketers provide you with the best results that you need from your social media outlets. We make sure the best team of social marketers are part of the campaigns being made for customers availing this package. Each and every feature by all means in this package is PREMIUM as the name says it.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for well-established seeking social media marketing services for personal or professional projects.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$398.00 <i class="cut"></i></span> <span class="price">$199.00 </span>             <ul class="no-scroll">
