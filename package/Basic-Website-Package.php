...
<title>Basic Web Package | Web development services | Web Ital Tech</title>


<meta name="description" content="This package is suitable for pre-existing multinational corporations and super startups aiming for brand reputation success." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Excellent Web Solutions For Small Personal and Corporate Projects  </h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Basic Web Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Starting up with a small personal or professional project? Well, it’s time for you to take a step into the future with our basic web package. The basic web package is perhaps the best package for small projects and startups. With a turnaround time that staggering fast, it’s easier to make sure your web is up and running.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for pre-existing multinational corporations and super startups aiming for brand reputation success.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$488.00 <i class="cut"></i></span> <span class="price">$244.00 </span>             <ul class="no-scroll">
