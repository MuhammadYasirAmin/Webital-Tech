...
<title>Corporate Website Package | Web development services | Web Ital Tech</title>


<meta name="description" content="This package is suitable for Super-Sized corporations aiming for web based success and looking for complete web package." />
...
header #header-sroll .nav-toggle span, header #header-sroll .nav-toggle span:before, header #header-sroll .nav-toggle span:after {
  background: #631a79;
}
...
#header-sroll.small .nav-toggle span, #header-sroll.small .nav-toggle span:before, #header-sroll.small .nav-toggle span:after {
  background: #631a79;
}
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Conceptual Web Solutions For Globally Acclaimed Corporations</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Corporate Web Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">If you’re looking for complete web solutions that are hassle-free for your company, this is just the package that you need. The package basically consists of a complete website between 15-20 pages with each and every feature of the website being custom for your business. For an iconic website, this is perhaps the best thing that you can get.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for Super-Sized corporations aiming for web based success and looking for complete web package.</p>

          <div class="actions text-left margin-top-20 wow fadeInDown" data-wow-delay="0.6s"> 
                        <input class="btn-fill-white" onClick="ordernow()" type="submit" value="ORDER NOW" tabindex="0">
             </div>
        </div>
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$4,788.00 <i class="cut"></i></span> <span class="price">$2,394.00 </span>             <ul class="no-scroll">
            ...
            <span class="sea">$500</span> for expedited services
                        
        </p>
            
            
            <div class="actions clearfix"> <a class="action-no inner-details gre clearfix"> <span class="icon-support"></span> <span><small>Share your idea?</small>+1-409-916-8842 <small class="border-right"></small></span> </a> <a onClick="contactpage()" class="action-chat ali clearfix pull-right" tabindex="0"> <span class="icon-chat"></span> <span><small>Want to discuss?</small> Live Chat Now</span></a> </div>
          </div>
        </div>
      </div>
    </div>
