...
<title>Startup Video Package | Video production agency | Web Ital Tech</title>


<meta name="description" content="This package is suitable for small brands seeking video production services for personal or professional projects." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Budget Friendly Animation and Video Production For Small Projects</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Startup Video Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Gone is the time when you needed text to create results that mattered. The audience is now starting to become a huge fan of video content and we’re here to help your business grow with it. The video startup package is the perfect budget package for brands seeking top class video editing and animation under a budget.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for small brands seeking video production services for personal or professional projects.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,598.00 <i class="cut"></i></span> <span class="price">$499.00 </span>             <ul class="no-scroll">
