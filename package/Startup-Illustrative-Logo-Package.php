...
<title>Startup Illustrative Logo Package | Web Ital Tech</title>


<meta name="description" content="This package is suitable for small startups and independent corporations on a budget seeking brand identity solutions." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Creative Illustrative Logos For Emerging Brands and Startups</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Startup Illustrative Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">The Startup Illustrative Package is basically one of the best packages in terms of illustrative logo package production. The package itself includes 4 custom design projects by 3 different designers. The package currently comes with unlimited revisions. With a 100% satisfaction rate and a money back guarantee, this is just the package that you need to make a difference in your industry.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for small startups and independent corporations on a budget seeking brand identity solutions.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$788.00 <i class="cut"></i></span> <span class="price">$384.00 </span>             <ul class="no-scroll">
