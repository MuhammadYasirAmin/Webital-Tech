...
<title>Startup Combo Package | Brand Development Company | Web Ital Tech</title>


<meta name="description" content="This package is suitable for small sized startups looking for an all in one brand package." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Skyrocket Your Startup With Apt Branding Solutions At The Perfect Price </h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Startup Combo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For a startup to excel in its respective industry, it needs exceptional branding solutions. Unfortunately, most startups don’t have the capital to pay for excellent branding solutions. With the Startup Combo Package, we aim to provide the client with the best of branding at a price that’s just too good to be true.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for small sized startups looking for an all in one brand package. </p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,988.00 <i class="cut"></i></span> <span class="price">$994.00 </span>             <ul class="no-scroll">
