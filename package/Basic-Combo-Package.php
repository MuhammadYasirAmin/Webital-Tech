...
<title>Basic Combo Package | Brand Development Packages | Web Ital Tech</title>


<meta name="description" content="This package is suitable for small sized brands or personal projects looking for an all in one brand package." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">The Perfect Combination Of Brand Development Solutions On A Budget </h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Basic Combo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">The basic combo package is our initial combo package made for small personal or professional projects and that too on a budget. From logo design to stationary design and even custom icon design, at a price that’s just too good to be true. The basic combo package is just what you need to create a brand at a budget.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for small sized brands or personal projects looking for an all in one brand package. </p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,288.00 <i class="cut"></i></span> <span class="price">$644.00 </span>             <ul class="no-scroll">
