...
<title>Professional Combo Package | Brand Development Agency | Web Ital Tech</title>


<meta name="description" content="This package is suitable for mega startups looking for an all in one brand package." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Globally Acclaimed Brand Development Solutions At The Perfect Price</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Professional Combo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Businesses that are pre-developed and are on the verge of becoming giants in the industry need a brand revamp suitable for expansion. The Professional Combo Package is made for brands that have succeeded or are succeeding and are looking to expand their wings. 8 of our best creative designers provide you with the best design and development solutions that you can possibly get. </p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for mega startups  looking for an all in one brand package. </p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$2,788.00 <i class="cut"></i></span> <span class="price">$1,394.00 </span>             <ul class="no-scroll">
