...
<title>Unlimited Social Package | Social media marketing | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Top Notch Social Media Marketing and Management Services For World Class Corporations.</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Unlimited Social Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For corporations that need a well-reputed social media presence over the web, this is the perfect package to avail. We dedicate the best social media marketers to this package creating the best social media existence.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1998.99 <i class="cut"></i></span> <span class="price">$999.99 </span>             <ul class="no-scroll">
