...
<title>Classic Video Package | Video production company | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Perfectly Crafted Video Production and Editing Solutions For ROI Centric Organizations </h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Classic Video Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">Our team of animators and video production experts love to provide the audience with everything that they need from a video on a budget. This is why collaborating with our business analysts, we came up with the video classic package providing top class video solutions to those needing it.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$2,198.00 <i class="cut"></i></span> <span class="price">$999.00 </span>             <ul class="no-scroll">
