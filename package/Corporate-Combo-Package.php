...
<title>Corporate Combo Package | Brand development agency | Web Ital Tech</title>


<meta name="description" content="This package is suitable for mega corporations looking for an all in one brand package." />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Corporate All-In-One Branding Solutions For Super-Sized Corporations</h3>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Corporate Combo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">There’s a difference between a corporation and a business; the difference is eye for perfection. The Corporate Combo Package is tailor made for globally widespread corporations looking for a change in their branding solutions. The corporate combo package creates maximum results for a mega corporation looking for brand revamp.</p>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">This package is suitable for mega corporations looking for an all in one brand package. </p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$3,988.00 <i class="cut"></i></span> <span class="price">$1,994.00 </span>             <ul class="no-scroll">
