...
<title>Professional Illustrative Logo Package | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Extraordinary Illustrative Design Solutions For Corporate Brands</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>Professional Illustrative Logo Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">The Professional Illustrative Logo Package is easily one of the most competitive package for illustrative logos in the industry. The package is tailormade for industry giants looking to switch to a better and more illustrative brand identity. The package features unlimited logo design concepts that are bound to impress the audience by 4 of the best designers.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,188.00 <i class="cut"></i></span> <span class="price">$584.00 </span>             <ul class="no-scroll">
