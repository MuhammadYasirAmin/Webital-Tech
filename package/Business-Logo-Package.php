...
<title>Business Logo package | Logo design services | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Corporate Brand Identity Solutions For Classy Business Entities</h3>
        </div>
      </div>
    </div>
  </section>
