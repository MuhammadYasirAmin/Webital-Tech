...
<title>E-Commerce Startup Package | Web Solutions | Web Ital Tech</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
          <h3 class="text-left breakdown-before-left margin-bottom-20">Affordable E-Commerce Solutions For Startup E-Stores</h3>
        </div>
      </div>
    </div>
  </section>
  <div class="section-padding branding-package branding-cust multiply package-detail-page wow">
    <div class="container">
      <div class="clearfix">
        ...
        <h3>E-Commerce Startup Package</h3>
          <p class="margin-bottom-40 wow fadeInDown text-center" data-wow-delay="0.4s">For an e-commerce business providing excellent web solutions in the market, a great website is just what they need for an excellent start. The Ecommerce Startup Package is just what you need to create results from the very start.</p>
        ...
        <div class="col-md-4 sec-combo-two wow fadeInDown" data-wow-delay="0.2s">
          ...
          <div class="single">
             ...
             <span class="old-price">$1,588.00 <i class="cut"></i></span> <span class="price">$794.00 </span>             <ul class="no-scroll">
